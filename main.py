...
def opengithub(event):
	webbrowser.open_new(r"https://github.com/ajaysaini10")


def openajaylinkedin(event):
	webbrowser.open_new(r"https://www.linkedin.com/in/ajay-saini-3a8a7b230/")
'''
-----------------------------------------------------------------
UPDATE ENTRY LABELS
-----------------------------------------------------------------
...
def main():
	...
	ajaysocial = Label(Aboutus, text="Ajay Saini")
	ajaysocial.bind("<Button-1>",openajaylinkedin)
	ajaysocial.grid(row=5, sticky='SW',padx = 8)
